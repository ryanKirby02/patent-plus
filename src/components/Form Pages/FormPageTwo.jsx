  ...
  return (
    <Container>
      ...
      <PageTwoContainer>
        <HeaderContainer>
          {stepOne === undefined ? (
            <h2>Now we know about you, tell us more details about your invention</h2>
          ) : (
            <h2> Okay {stepOne.lastName}, now we know about you, tell us more details about your invention</h2>
          )}
        </HeaderContainer>
